...
class TestBoardLayout(unittest.TestCase):
    ...
    def test_iterate_adjacent_length(self):
        self.assertEqual(len(list(layout.iterate_adjacent((0, 0)))), 2)
        self.assertEqual(len(list(layout.iterate_adjacent((2, 2)))), 4)
        self.assertEqual(len(list(layout.iterate_adjacent((1, 2)))), 8)
        self.assertEqual(len(list(layout.iterate_adjacent((2, 5)))), 6)
